...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <a href="http://localhost:8080/RegistrationSample/sampleController.htm?action=exhibitor"><button type="button" class="btn"><i class="fa fa-suitcase" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;OnBoard Exhibitor</button></a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://localhost:8080/RegistrationSample/sampleController.htm?action=entrepreneur"><button type="button" class="btn"><i class="fa fa-male" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;OnBoard Entrepreneur</button></a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://localhost:8080/RegistrationSample/sampleController.htm?action=producer"><button type="button" class="btn"><i class="fa fa-usd" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;OnBoard Producer</button></a>
