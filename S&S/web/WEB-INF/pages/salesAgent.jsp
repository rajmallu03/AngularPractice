...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="row">
    <div class="col-sm-3">
      <a href="http://localhost:8080/RegistrationSample/sampleController.htm?action=showregister"> <button type="button" class="btn"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;ADD SALES AGENT</button></a>
    </div>
    <div class="col-sm-9">
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <table style="height: 400px; width: 700px;">
            <tbody>
            <tr>
              <td colspan="2" height="100" width="700">
                <%@ include file="/grid.jsp"%></td>
            </tr>
            </tbody>
          </table>
