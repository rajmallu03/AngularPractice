...
<div id="login-box">
    ...
    <form name='loginForm' method='POST' action="sampleController.htm?action=onboards" class="login">
        <center><p>ONBOARD EXHIBITOR</p></center>
        <hr>
        ...
        <table border="0" align="center">
            ...
            <tr>
                ...
                <td><input id="category" maxlength="10" type="text" name="category" style="width: 300px; display: none" value="Exhibitor"/></td>
            </tr>
