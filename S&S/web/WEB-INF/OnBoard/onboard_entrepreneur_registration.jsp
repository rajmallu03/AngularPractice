...
<html>
<head>
    <title>Add an Entrepreneur</title>
    <meta charset="utf-8">
    ...
    <script>
        function TextChanged(){
            ...
            document.getElementById("id2").value =  theatre.substring(0, 3) +state.substring(0, 3) +city.substring(0, 2)+zip.substring(0, 2)
                +theatre_type.substring(0, 1)+theatre_types.substring(0, 1);
...
<div id="login-box">
    ...
    <form name='loginForm' method='POST' action="sampleController.htm?action=onboards" class="login">
        <center><p>ONBOARD ENTREPRENEUR</p></center>
        <hr>
        ...
        <table border="0" align="center">
            ...
            <tr>
                ...
                <td><input id="category" maxlength="10" type="text" name="category" style="width: 300px; display: none" value="Entrepreneur"/></td>
            </tr>
            ...
            <tr>
                ...
                <td><input id="id2" type="text" name="id2" style="width: 300px; display: none"/></td>
            </tr>
...
--%>
        ...
        <input name="submit" type="submit" value="SUBMIT" class="button" onClick="window.location.href='sampleController.htm?action=exhibitor'"/>
        <input name="cancel" type="submit" class="button2" value="CANCEL"/>
        <a class="nav-link" data-toggle="modal" data-target="#exampleModal">
            <input name="cancel" type="button" class="button2"  value="NEXT"/></a>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="http://localhost:8080/RegistrationSample/sampleController.htm?action=aboutTheatre_ex">
