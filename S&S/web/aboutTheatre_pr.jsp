  ...
  <i class="fa fa-circle fa-stack-2x icon-background1"></i><i class="fa fa-circle-o-notch fa-stack-1x" aria-hidden="true" style="font-size:30px;color:white;"></i></span><br></li>
    ...
    <div id="field_size">
        ...
        <fieldset>
            ...
            <div class="auto">
                <div class="form-row">
                    <label>
                        <span>Category:</span>
                        <input type="text" name="category" Value="Producer" readonly>
                    </label>
                </div>
            <div class="form-row">
                <label>
        ...
        <fieldset>
            ...
            <input type="button" name="previous" class="previous action-button" value="Previous" />
            <input type="submit" name="submit"  value="Submit" onClick="window.location.href='sampleController.htm?action=customers'"/>
